...
HeaterController::HeaterController(CurrentThermostatStatus* currentThermostatStatus, MqttLogistics *mqttLogistics)
{
    _currentThermostatStatus = currentThermostatStatus;
    _mqttLogistics = mqttLogistics;
}

void HeaterController::loopForQueuedCompressorHandling()
{
...
void HeaterController::allOffFanModeRespected()
{
    setCompressorState(STATE_OFF);
    setReverserValveState(STATE_OFF);
...
void HeaterController::startCooling()
{
...
void HeaterController::turnOffAllButFan()
{
...
void HeaterController::setCompressorState(bool newState)
{
    if (!newState)
    {
...
void HeaterController::setReverserValveState(bool newState)
{
    if (!newState)
...
void HeaterController::setFanState(bool newState)
{
    if (!newState)
    {
